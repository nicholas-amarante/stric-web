  ...
  return (
    <BrowserRouter>
      <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
        ...
        {/* Footer com conformidade LGPD */}
        <footer className="border-t border-slate-900 bg-slate-950/60 py-8 mt-16 text-xs text-slate-500">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-lg bg-brand-600/20 text-brand-400 flex items-center justify-center">
                <Bot size={14} />
              </div>
              <span className="font-semibold text-slate-400">STRIC</span>

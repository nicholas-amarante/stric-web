...
export const CandidateHomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-10 py-6">
      {/* Hero Banner */}
      <div className="glass-panel p-8 sm:p-12 rounded-3xl relative overflow-hidden border border-slate-200/80 dark:border-slate-800">
        ...
        <div className="max-w-3xl space-y-4 relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-brand-500/15 text-brand-600 dark:text-brand-300 border border-brand-500/30">
            <Sparkles size={13} />
          ...
          {/* Destaques */}
          <div className="flex flex-wrap gap-4 pt-4 text-xs font-medium text-slate-700 dark:text-slate-300">
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs font-semibold px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 shadow-sm">
